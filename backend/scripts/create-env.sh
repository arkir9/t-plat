...
# Quick script to create .env and .env.example files
...
# ============================================
# T-Plat Backend Environment Configuration
# ============================================
...
JWT_EXPIRATION=7d
JWT_REFRESH_SECRET=change-this-to-a-random-refresh-secret-key-in-production
...
# M-Pesa (Safaricom Daraja API - Kenya)
...
# ============================================
# SMS Configuration (Optional - Twilio/African SMS)
# ============================================
...
if [ ! -f .env ]; then
    echo "Creating .env with generated JWT secrets..."
    cat > .env << ENVFILE
# ============================================
# T-Plat Backend Environment Configuration
# ============================================
...
TWILIO_PHONE_NUMBER=your_twilio_phone_number
ENVFILE
    echo "✅ Created .env file with generated JWT secrets:"
...
echo "2. Add API keys (Stripe, M-Pesa, Cloudinary, etc.)"
